			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<c:if test="${not empty message }">
						...
						<div class="card-header h3">Infor Category</div>
						<div class="card-body">
							<sf:form modelAttribute="cate"
								action="${base }/admin/category/addorupdate" method="post"
								...
								<div class="mb-3">
									<label for="summernote" class="form-label">Desciption:</label>
									<sf:textarea path="description" class="form-control"
										id="" rows="6" placeholder="Enter description"
										onfocus="this.placeholder = ''"
										onblur="this.placeholder = 'Enter desciption'"></sf:textarea>
								</div>
