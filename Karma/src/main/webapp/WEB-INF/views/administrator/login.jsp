...
<body class="bg-gradient-primary"
	style="background-image: url('${base }/img/banner/banner-bg.jpg');">
	...
	<div class="container w-50">
		...
		<div class="row justify-content-center">
			...
			<div class="col-xl-12 col-lg-10 col-md-8">
				...
				<div class="card o-hidden border-0 bg-gray-300 shadow-lg bg-color-customer my-5">
						...
						<div class="row">
							...
							<div class="col-lg-12">
								<div class="p-5">
									...
									<form class="user"  action="${base }/login_processing_url" method="post">
									...
									<c:if test="${not empty param.login_error}">
										...
										<button type="submit"
											class="btn btn-primary btn-user btn-block border-0"> Login </button>
										<hr>
									...
									<hr>
									<div class="text-center">
										<a class="small" href="${base }/password/forget">Forgot
											Password?</a>
									</div>
									<div class="text-center">
